...
export default async function SearchPage() {
  ...
  return <SearchPageClient categories={categories} menu={menu} />
}

function SearchPageClient({ categories, menu }: { categories: { id: string; name: string; slug: string }[]; menu: Awaited<ReturnType<typeof getHeaderMenu>> }) {
  ...
  return (
    <div className="site-public">
      <style>{`
        ...
        .site-public .search-submit:disabled { opacity: .65; cursor: default; }
